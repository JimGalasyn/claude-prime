...
def run_comparison(R=3.0, r=1.0, steps=2000, save=False):
    ...
    plt.tight_layout()
    if save:
        path = '/home/jim/repos/claude-prime/simulations/torus_comparison.png'
...
def run_modes(R=3.0, r=1.0, steps=5000, save=False):
    ...
    plt.tight_layout()
    if save:
        path = '/home/jim/repos/claude-prime/simulations/torus_modes.png'
        plt.savefig(path, dpi=150, bbox_inches='tight')
        print(f"\nSaved: {path}")
    else:
        plt.show()
...
def run_golden(steps=3000, save=False):
    ...
    plt.tight_layout()
    if save:
        path = '/home/jim/repos/claude-prime/simulations/torus_golden.png'
        plt.savefig(path, dpi=150, bbox_inches='tight')
        print(f"\nSaved: {path}")
    else:
        plt.show()
