...
def run_single(R=3.0, r=1.0, steps=3000, save=False):
    ...
    plt.tight_layout()
    if save:
        path = '/home/jim/repos/claude-prime/simulations/braided_single.png'
...
def run_braided(R=3.0, r=1.0, n_strands=3, braid=1, coupling=0.5,
    ...
    plt.tight_layout()
    if save:
        path = f'/home/jim/repos/claude-prime/simulations/braided_{n_strands}s_b{braid}.png'
        plt.savefig(path, dpi=150, bbox_inches='tight')
        print(f"Saved: {path}")
    plt.close()
...
def run_spectrum(R=3.0, r=1.0, steps=3000, coupling=0.5, save=False):
    ...
    plt.tight_layout()
    if save:
        path = '/home/jim/repos/claude-prime/simulations/braided_spectrum.png'
        plt.savefig(path, dpi=150, bbox_inches='tight')
        print(f"\nSaved: {path}")
    plt.close()
