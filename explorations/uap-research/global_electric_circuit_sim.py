...
def main():
    ...
    plt.tight_layout()
    plt.savefig('/home/jim/repos/claude-prime/gec_simulation_overview.png', dpi=150, bbox_inches='tight')
    print(f"\nSaved: gec_simulation_overview.png")
...
""")
    ...
    plt.tight_layout()
    plt.savefig('/home/jim/repos/claude-prime/gec_plasma_stability.png', dpi=150, bbox_inches='tight')
    print(f"Saved: gec_plasma_stability.png")
